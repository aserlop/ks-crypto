...
from ks_crypto.modeling.node_cls_tasker import NodeClsTasker
from ks_crypto.modeling import splitter as sp, egcn_h, models as mls, cross_entropy as ce, trainer as tr
...
def main():
    ...
    try:
        ...
        nodes_df = read_input_table(spark, n_input_tablename, f_min, f_max)
        log_detalle.info("Conteo del tablon de nodos {count}".format(count=nodes_df.count()))

        transactions_df = read_input_table(spark, t_input_tablename, f_min, f_max)
